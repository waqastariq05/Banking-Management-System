...
void view_list()
{
    ...
    while(fscanf(view,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d",&add.acc_no,add.name,&add.dob.month,&add.dob.day,&add.dob.year,&add.age,add.address,add.citizenship,&add.phone,add.acc_type,&add.amt,&add.deposit.month,&add.deposit.day,&add.deposit.year)!=EOF)
       {
           printf("\n%6d\t %10s\t\t\t%10s\t\t%d",add.acc_no,add.name,add.address,add.phone);
           test++;
       }
...
void close(void)
{
    printf("\n\n\n\nThis C Project is developed by Waqas Tariq !");
    }
...
{   int choice;
    ...
    system("color A0");
    printf("\n\t\t=========================================\n");
    printf("\t\tALIGARH ACCOUNT BANKING MANAGEMENT SYSTEM\n");
    printf("\t\t=========================================");
    printf("\n\n\n\t\t\tWELCOME TO THE MAIN MENU ");
    printf("\n\n\t\t1.CREATE YOUR NEW ALIGARH ACCOUNT\n\t\t2.UPDATE INFORMATION OF EXITSTING ACCOUNT\n\t\t3.FOR TRANSACTIONS\n\t\t4.CHECK THE DETAIL OF EXISTING ACCOUNT\n\t\t5.REMOVING EXISTING ACCOUNT\n\t\t6.VIEW EMPLOYEE's LIST\n\t\t7.EXIT\n\n\n\n\n\t\t Enter your choice:");
    scanf("%d",&choice);
...
int main()
{
    char pass[10],password[10]="aligarh";
    int i=0;
    system("color B0");
    printf("\n\n\t=============================================");
    printf("\n\n\t      *********************************");
    printf("\n\n\n\t\t\t WELCOME TO \n\n\n\t\t  ALIGARH BANKING MANGEMENT\n\n");
    printf("\n\n\t      *********************************");
    printf("\n\n\t=============================================");
